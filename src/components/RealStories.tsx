      ...
      <div className="h-full z-10 md:px-32 px-6 grid grid-cols-1 gap-6 md:grid-cols-[1fr_1.1fr_auto] md:items-start">
        <div className="">
          <div
            ...
            className="inline-flex md:items-center md:justify-center rounded-2xl bg-[#F3EFED] px-3 py-1 md:text-[14px] text-[12px] font-light  text-[#2C3C44]"
          >
            {overline}
          </div>
          <h2
        ...
        <div className="md:mt-2 md:mt-auto md:text-right">
          <button
            onClick={onCtaClick}
            /* CHANGE: Added 'w-full' for mobile and 'md:w-auto' for desktop */
            className="w-full rounded-full px-5 py-3 text-[14px] font-medium md:w-auto md:text-[16px]"
            style={{
              background: "#A8CFA1",
              color: "#2C3C44",
              fontFamily: "Giphurs, ui-sans-serif, system-ui",
    ...
    >
      ...
      <figcaption className="mt-auto flex items-center justify-between">
        ...
        >
          {name}
          {age !== undefined ? (
            <span className="ml-1 md:text-[14px] text-[12px] font-light text-[#64737A]">
              , {age}
            </span>
          ) : null}
        </div>
